            ...
            <main style={{ maxWidth: '850px', margin: '40px auto', padding: '0 20px' }}>
                <div style={{ background: theme.paper, padding: '80px', borderRadius: '4px', boxShadow: '0 20px 50px rgba(0,0,0,0.05)', minHeight: '1000px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '60px' }}>
                        <span style={{ background: theme.accent + '10', color: theme.accent, padding: '4px 12px', borderRadius: '6px', fontSize: '12px', fontWeight: '900', textTransform: 'uppercase' }}>{proyecto.tematica}</span>
                        <span style={{ color: theme.subtext, fontSize: '13px', fontWeight: '500' }}>Creado el {new Date(proyecto.created_at).toLocaleString()}</span>
                    </div>
